...
def slack_location_message(channel_id, message, app):
    print(
...
def conversation_history_ai(channel_id, applicationReffered):
    ...
    url = f"{base_url}/conversations.history"
    token = get_slack_token()  # Make sure you have a function named get_slack_token that returns your Slack token
